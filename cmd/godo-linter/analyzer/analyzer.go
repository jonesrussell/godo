// Package analyzer provides custom linting rules for the Godo project.
// It enforces project-specific conventions such as error wrapping,
// interface segregation, and test patterns.
package analyzer
